...
class WGraph_AlgoTest {
    ...
    @Test
    void checkTest(){
        weighted_graph g1 = small_graph();
        weighted_graph_algorithms ag1 = new WGraph_Algo();
        ag1.init(g1);
        weighted_graph g2 = ag1.copy();
        assertEquals(g1,g2);
    }
    ...
    private weighted_graph create_graph() {
        weighted_graph g0 = WGraph_DSTest.graph_creator(4,0,1);
        g0.connect(0,1,10);
        g0.connect(0,2,2);
        return g0;
    }
    ...
    @Test
        void Test_connect(){//checks the connectivity of the graph
        weighted_graph g0 = create_graph();
        weighted_graph_algorithms ag0 = new WGraph_Algo();
        ag0.init(g0);
        assertFalse(ag0.isConnected());
    ...
    @Test
    void Test_dijkstra(){//checks if dijkstra works
        weighted_graph g0 = WGraph_DSTest.graph_creator(3,0,1);
        weighted_graph_algorithms ag0 = new WGraph_Algo();
        ag0.init(g0);
        g0.connect(0,1,1);
        g0.connect(0,2,3);
        g0.connect(1,2,1);
        assertEquals(2,ag0.shortestPathDist(0,2));
    ...
    void notCopyTest(){
        weighted_graph g0 = create_graph();
        weighted_graph g1 = create_graph();
        assertEquals(g0,g1);
        g1.removeNode(0);
        assertNotEquals(g0,g1);
    }
